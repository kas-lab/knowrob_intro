...
if __name__ == '__main__':
    ...
    print(
        "Transfer operations that move items (X) from"
        "their current location (O) to a correct  destination (D), according"
        " to these rules:\n perishable items to the refrigerated table,"
        "and nonperishable items to other tables:")
